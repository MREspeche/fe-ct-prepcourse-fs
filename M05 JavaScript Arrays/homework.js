...
function agregarNumeros(arrayOfNums) {
   ...
   //FOR para recorrer el array.-- Declarar ìndice con primera posición cero i = 0;
   //i < arrayOfNames. -- arrayOfName[i] se trata del elemento que está adentro en esa posición.
   // Tu código:
   var suma = 0
